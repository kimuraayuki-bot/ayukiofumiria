  ...
  sections: [
    {
      ...
      bodyJa: [
        ...
        "HP制作やWebアプリ開発の実績もあり、技術の幅を広げている。",
      ],
    ...
    },
    {
      ...
      bodyJa: [
        "電子工作・プログラミング教室の立ち上げと運営。",
        "オリジナル電子工作教材の開発。",
        "電子工作・プログラミングのワークショップを開催。",
        "作曲体験イベントの開催。",
        "ロボット教育をテーマにし、Startup Weekend、学内ビジネスコンテストで優勝。",
    ...
    },
    {
      ...
      summaryJa: "第三種電気主任技術者、第一種電気工事士などの難関国家資格を多数保有し、東大GCI修了・TOEIC855の実績を持つ。Webアプリ・システム開発から電子工作・組込み開発まで一貫して実装できる横断型エンジニア。",
      bodyJa: [
        "技術・制作：",
        "Webアプリ・サービス開発",
        "システム開発",
    ...
    },
    {
      ...
      bodyJa: [
        "Umiria（ウミリア）は、アミール・D・アクゼル著『宇宙創造の一瞬をつくる』に登場する献辞──「宇宙を愛するミリアムへ」──に着想を得て生まれた造語である。 「ミリアム（Miriam）」という名が内包する、宇宙への愛と限りない探求のまなざし。 その精神を、自身の創作・思索・技術の営みにおける世界観や概念として再構築したものが、Umiriaである。 この名前は、無限に広がる思索と、静かに燃える情熱の象徴として、 活動名「Ayuki of Umiria（ウミリアのアユキ）」にも結びついている。",
      ],
