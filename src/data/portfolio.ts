  ...
  mediaLinks: [
    {
      ...
      type: "article",
      priority: 1,
      previewImage: "/images/media/kobe-2021.svg",
    },
    {
      label: "神戸新聞（2022）",
      ...
      type: "article",
      priority: 2,
      previewImage: "/images/media/kobe-2022.svg",
    },
    {
      label: "Key Site（2025）",
      ...
      type: "article",
      priority: 3,
      previewImage: "/images/media/keysite-2025.svg",
    },
    {
      label: "和歌山大学 広報（2026）",
      ...
      type: "article",
      priority: 4,
      previewImage: "/images/media/wakayama-univ-2026.svg",
    },
  ],
  sections: [
    {
      ...
      bodyJa: [
        ...
        "HP制作やWebアプリ、iPhoneアプリ開発の実装もあり、技術の幅を広げている。",
      ],
