...
export const portfolioData: PortfolioData = {
  profile: {
    ...
    currentStatus: [
      "最近では起業体験イベント Startup Weekend と学内ビジネスコンテストで優勝。",
  ...
  sections: [
    ...
    },
    {
      ...
      summaryJa: "開発スキル・修了情報・語学・資格を一覧化。",
      bodyJa: [
        "システム開発（業務効率化）。",
        "Webアプリケーション開発（診断ツールやチャットボット等）。",
        "修了・語学：東京大学 GCI Winter 2024 修了、TOEIC L&R 855。",
        "資格：日商簿記3級、普通自動車免許。",
        "高校在学中に取得：第三種電気主任技術者（合格率8.3%）、第一種電気工事士（筆記・実技試験合格）、第二種電気工事士、ITパスポート、工事担任者（アナログ／デジタル）、乙種消防設備士7類、第二級陸上・海上特殊無線技士、2級電気工事施工管理技士補。",
      ],
